...
in
{
  ...
  nix2luaAll = isEqual (nix2lua complexTable) "{a = 1, b = true, c = \"c\", d = {1, \"a\", {d = 1}, {1}}, e = {a = {a = 1, b = 2}, b = {a = 1}}}";

  nix2luaEmptyAttrs = isEqual (nix2lua { }) "{}";
  nix2luaEmptyList = isEqual (nix2lua [ ]) "{}";
  nix2luaNull = isEqual (nix2lua { a = null; }) "{a = null}";
  nix2luaMixedList = isEqual (nix2lua [
    1
    "a"
    true
    null
  ...
  nix2luaNestedList = isEqual (nix2lua [
    [
      1
      2
    ]
  ...
  nix2luaNestedAttrs = isEqual (nix2lua {
    a = {
      b = {
        c = 1;
      };
...
";
  ...
  toTableSimple = isEqual (nix2lua (toTable {
    a = 1;
  })) "{a = 1}";
  toTableNested = isEqual (nix2lua (toTable {
    a = {
      b = 1;
    };
  })) "{a = {b = 1}}";
  ...
  callWithAttrs = isEqual (attrs2Lua {
    a = callWith {
      x = 1;
      y = "z";
    };
...
";
  callWithList = isEqual (attrs2Lua {
    a = callWith [
      1
      2
      3
...
" (builtins.readFile ./attrs2lua.lua);
  ...
  deepCustomTypes = isEqual (attrs2Lua tableWithCustomTypes) "a.a({a = some code, b = {1, 2}, c = {a = {a = someVar}}})
";
